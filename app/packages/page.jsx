...
export default function PackagesPage() {
  ...
  const fetchPackages = async () => {
    try {
      setIsLoading(true);
      const { data } = await axios.get('https://custom-gpt-backend-six.vercel.app/api/package/getpackages');
  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        const { data } = await axios.get('https://custom-gpt-backend-six.vercel.app/api/protected/protected-content', {
          data: { userId },
        });
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const { data } = await axios.post('https://custom-gpt-backend-six.vercel.app/api/package/stripe/create-checkout-session', {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-indigo-900 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* <iframe
          src="$https://custom-gpt-builder-frontends-lvhs.vercel.app/widget/118348517020939070586/682c7e24b707fc071614dfbe"
          width="100%"
          height="500px"
          frameborder="0"
   ...
   <iframe
      src="https://custom-gpt-backend-six.vercel.app/api/chatbot/682c7e24b707fc071614dfbe/118348517020939070586"
      style={{
        width: '400px',
        height: '600px',
        border: 'none',
